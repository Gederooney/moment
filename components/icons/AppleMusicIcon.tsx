...
export function AppleMusicIcon({ size = 24, color }: AppleMusicIconProps) {
  // Pour une icône simple, on va juste utiliser le symbole musical blanc
  // Si color est fourni, on l'utilise pour le symbole
  const symbolColor = color || '#FFFFFF';

  return (
    <Svg width={size} height={size} viewBox="0 0 361 361">
      <Defs>
        <LinearGradient id="appleGradient" x1="0%" y1="100%" x2="0%" y2="0%">
          <Stop offset="0" stopColor="#FA233B" />
          <Stop offset="1" stopColor="#FB5C74" />
        </LinearGradient>
      </Defs>

      {/* Background avec gradient si pas de couleur personnalisée */}
      {!color && (
        <Path
